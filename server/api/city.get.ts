import {LocationResponseSchema, LocationResponse} from '@/utils/openWeatherMap'
import { z } from 'zod'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const validatedResponse: LocationResponse = LocationResponseSchema.parse(response);
